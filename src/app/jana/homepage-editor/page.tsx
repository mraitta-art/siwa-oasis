...
const HOMEPAGE_SECTIONS: HomepageSection[] = [
  ...
  },
  {
    id: 'services-hub',
    name: 'Services Hub',
    description: 'Directory of services & business categories',
    icon: 'fa-server-group',
    status: 'editable',
    managerPath: '/jana/businesses',
    color: '#8b5cf6',
  },
  {
    id: 'experience-categories',
    name: 'Experience Categories',
    description: 'Interactive category discovery cards',
  ...
  },
  {
    ...
    description: 'Discovery search engine with filters',
    icon: 'fa-search',
    status: 'editable',
    managerPath: '/jana/search-engines',
    color: '#f59e0b',
  },
  {
    id: 'blog',
  ...
  },
  {
    ...
    description: 'Trip planning tool with curated journey templates',
    icon: 'fa-route',
    status: 'editable',
  ...
  },
  {
    id: 'ecosystem-map',
    name: 'Ecosystem Map',
    description: 'Interactive map visualization of Siwa oasis',
    icon: 'fa-map',
    status: 'editable',
    color: '#8b5cf6',
  },
  {
    ...
    description: 'Artisan & local goods highlight section',
    icon: 'fa-store',
    status: 'editable',
    color: '#ec4899',
  },
