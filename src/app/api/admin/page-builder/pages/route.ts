 ...
 * POST /api/admin/page-builder/pages - Create new page
 * GET /api/admin/page-builder/pages - Get all pages
 * PUT /api/admin/page-builder/pages/:id - Update page
 * DELETE /api/admin/page-builder/pages/:id - Delete page
 */

import { NextRequest, NextResponse } from 'next/server';
import { createPageLayout, getAllPages } from '@/lib/admin/page-builder-service';
