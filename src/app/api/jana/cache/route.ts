 ...
 * GET /api/jana/cache/stats - Get cache statistics
 * POST /api/jana/cache/invalidate - Invalidate specific or all caches
 * POST /api/jana/cache/revalidate - Force revalidation of specific cache
 */
