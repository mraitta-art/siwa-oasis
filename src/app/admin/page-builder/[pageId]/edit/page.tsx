...
export default function PageEditorPage() {
  ...
  return (
    <div style={{ padding: '3rem', textAlign: 'center', background: 'rgba(0,0,0,0.2)', borderRadius: '1rem', color: '#fff' }}>
      ...
      <button onClick={() => router.push('/admin/orchestrator')} style={{ background: '#D4AF37', color: '#1a1a2e', border: 'none', padding: '0.75rem 2rem', borderRadius: '4px', fontWeight: 800, cursor: 'pointer' }}>
        GO TO WIZARD
      </button>
    </div>
  );
