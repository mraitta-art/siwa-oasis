...
const NAV_GROUPS = [
  {
    ...
    collapsible: false,
    items: [
      { name: '1. Foundation Architect', path: '/admin/governance', icon: 'fa-microchip', exact: true },
      { name: '2. Onboarding Wizard', path: '/admin/orchestrator', icon: 'fa-magic' },
      { name: '3. Business Registry', path: '/admin/businesses', icon: 'fa-briefcase' },
      { name: '4. Visual Orchestrator', path: '/admin/website', icon: 'fa-palette' },
      { name: '5. Data Manager', path: '/admin/data-manager', icon: 'fa-server' },
    ]
  },
  {
    id: 'architect',
    ...
    collapsible: true,
    items: [
      { name: 'Business Types', path: '/admin/types', icon: 'fa-folder-tree' },
      { name: 'Data Sections', path: '/admin/sections', icon: 'fa-columns' },
      { name: 'Form Fields', path: '/admin/form-builder', icon: 'fa-list-check' },
    ]
  },
  {
    id: 'components',
    ...
    collapsible: true,
    items: [
      { name: 'Component Library', path: '/admin/component-library', icon: 'fa-layer-group' },
      { name: 'Hero Carousel', path: '/admin/hero-carousel', icon: 'fa-images' },
      { name: 'Blog Manager', path: '/admin/blog', icon: 'fa-newspaper' },
    ]
  }
];
...
function AdminLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  const getPageGuide = () => {
    if (pathname === '/admin') return { title: 'Governance Dashboard', tip: 'Overview of your marketplace ecosystem. Start the Foundation Architect for blueprint setup.' };
