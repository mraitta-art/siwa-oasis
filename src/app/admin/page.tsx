  ...
  return (
    <>
      <div style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)', color: '#fff', padding: '2rem', borderRadius: '1rem', marginBottom: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <a href="/admin/orchestrator" className="btn btn-primary" style={{ padding: '0.75rem 2rem', textDecoration: 'none', fontWeight: 800 }}>LAUNCH WIZARD</a>
      </div>
      ...
      <div style={{ background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', color: '#fff', padding: '1.5rem', borderRadius: '1rem', marginBottom: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <a href="/admin/form-builder" className="btn" style={{ padding: '0.75rem 2rem', textDecoration: 'none', fontWeight: 800, background: '#fff', color: '#d97706', borderRadius: '0.5rem' }}>OPEN BUILDER</a>
      </div>

      <div className="stats">
        <a href="/admin/types" className="stat" style={{ textDecoration: 'none' }}>
          <div className="stat-value">{(typeCount as any)?.count || 0}</div>
          <div className="stat-label">Business Types</div>
        </a>
        <a href="/admin/businesses" className="stat" style={{ textDecoration: 'none' }}>
          <div className="stat-value">{(bizCount as any)?.count || 0}</div>
          <div className="stat-label">Businesses</div>
        </a>
        <a href="/admin/upgrades" className="stat" style={{ textDecoration: 'none', borderLeft: '3px solid #10b981' }}>
