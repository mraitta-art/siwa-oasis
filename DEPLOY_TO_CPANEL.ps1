...
if (Test-Path ".env.production") {
    ...
    Write-Host "   ⚠️  .env.production not found - YOU MUST CREATE IT on cPanel" -ForegroundColor Yellow
}
...
Write-Host ""
Write-Host "📦 Step 3: Creating compressed archive..." -ForegroundColor Yellow
...
Write-Host "1️⃣  DOWNLOAD this file from your computer:" -ForegroundColor Cyan
Write-Host "   $ZipPath" -ForegroundColor White
Write-Host ""

Write-Host "2️⃣  LOGIN to cPanel at:" -ForegroundColor Cyan
Write-Host "   https://siwa.today:2083" -ForegroundColor White
Write-Host "   OR" -ForegroundColor Gray
Write-Host "   cpanel.siwa.today" -ForegroundColor White
Write-Host ""

Write-Host "3️⃣  UPLOAD via File Manager:" -ForegroundColor Cyan
...
Write-Host "4️⃣  RESTART app in cPanel:" -ForegroundColor Cyan
...
Write-Host "✨ YOUR LIVE SITE:" -ForegroundColor Yellow
...
Write-Host "✅ Done! Follow the 4 steps above to deploy." -ForegroundColor Green
